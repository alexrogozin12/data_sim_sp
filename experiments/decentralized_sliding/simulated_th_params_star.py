...
from experiment_utils import star_adj_mat, metropolis_weights, run_experiment


def exp_star(num_nodes: int, noise: float):
    print("-------- Star graph, {} nodes, noise = {} --------".format(num_nodes, noise))
    ...
    folder = "./logs/star_nodes={}_noise={:.2e}".format(num_nodes, noise)
