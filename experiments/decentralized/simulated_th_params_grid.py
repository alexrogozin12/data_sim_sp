...
from experiment_utils import grid_adj_mat, metropolis_weights, run_experiment


def exp_grid(width: int, noise: float):
    num_nodes = width**2
    print("-------- Grid graph, {} nodes, noise = {} --------".format(num_nodes, noise))
    ...
    folder = "./logs/grid_nodes={}_noise={:.2e}".format(num_nodes, noise)
